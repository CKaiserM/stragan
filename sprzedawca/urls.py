...
urlpatterns = [
    ...
    path('zarzadzaj-produktami/', views.ProductManagerView.as_view(), name="copmany_products"),
    path('zarzadzaj-produktami/dodaj-produkt/', views.AddProductView.as_view(), name="add_product"),
    path('zarzadzaj-produktami/aktualizuj-produkt/<int:pk>', views.UpdateProductView.as_view(), name="update_product"),
